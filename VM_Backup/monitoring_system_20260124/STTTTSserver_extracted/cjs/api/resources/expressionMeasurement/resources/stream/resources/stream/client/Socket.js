...
const StreamModelsEndpointPayload_js_1 = require("../../../../../../../../serialization/resources/expressionMeasurement/resources/stream/resources/stream/types/StreamModelsEndpointPayload.js");
class StreamSocket {
    constructor(args) {
        this.eventHandlers = {};
        this.handleOpen = () => {
    ...
    sendPublish(message) {
        ...
        const jsonPayload = StreamModelsEndpointPayload_js_1.StreamModelsEndpointPayload.jsonOrThrow(message, {
            unrecognizedObjectKeys: "passthrough",
            allowUnrecognizedUnionMembers: true,
            allowUnrecognizedEnumValues: true,
            skipValidation: true,

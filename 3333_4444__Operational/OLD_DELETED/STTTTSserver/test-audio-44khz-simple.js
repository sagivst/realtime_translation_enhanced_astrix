#!/usr/bin/env node
/**
 * Simple Test Audio Server - Plays existing 44.1kHz audio to extension 9008
 */
  ...
  ws.on('message', (message) => {
    try {
      ...
      if (data.event === 'audio' && data.extension === '9008') {
        ...
        console.log(`[9008] ✓ Sent ${audioData.length} bytes @ 44.1kHz\n`);
      }
    } catch (e) {
      // Ignore parse errors
    }
...
console.log('\n📞 NOW CALL: 9007 → 9008');
console.log('🎵 Speak into 9007, you should hear test audio on 9008');

...
\restrict pCofjGd4hfzcL0wTvYCSGcqkhibTneCpmWPeMWTROFCuDGhcbxpgALBnBkpJHlF
...
--
-- Name: knob_apply_requests; Type: TABLE; Schema: public; Owner: monitoring_user
--

CREATE TABLE public.knob_apply_requests (
    idempotency_key uuid NOT NULL,
    trace_id character varying(255) NOT NULL,
    station_key character varying(50) NOT NULL,
    apply_at_bucket_ts timestamp without time zone NOT NULL,
...
ALTER TABLE public.knob_apply_requests OWNER TO monitoring_user;

--
-- Name: knob_apply_verification; Type: TABLE; Schema: public; Owner: monitoring_user
--

CREATE TABLE public.knob_apply_verification (
    id integer NOT NULL,
    idempotency_key uuid NOT NULL,
    trace_id character varying(255),
    station_key character varying(50),
    config_version integer,
    applied_knobs jsonb,
...
ALTER TABLE public.knob_apply_verification OWNER TO monitoring_user;

--
-- Name: knob_apply_verification_id_seq; Type: SEQUENCE; Schema: public; Owner: monitoring_user
--

CREATE SEQUENCE public.knob_apply_verification_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.knob_apply_verification_id_seq OWNER TO monitoring_user;

--
-- Name: knob_apply_verification_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: monitoring_user
--

ALTER SEQUENCE public.knob_apply_verification_id_seq OWNED BY public.knob_apply_verification.id;
...
--
-- Name: knob_verifications; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.knob_verifications (
    id integer NOT NULL,
    trace_id character varying(255),
    station_key character varying(50),
    bucket_ts timestamp with time zone,
    knob_key character varying(100),
...
ALTER TABLE public.knob_verifications OWNER TO postgres;

--
-- Name: knob_verifications_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.knob_verifications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.knob_verifications_id_seq OWNER TO postgres;

--
-- Name: knob_verifications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.knob_verifications_id_seq OWNED BY public.knob_verifications.id;
...
--
-- Name: pending_knob_applications; Type: VIEW; Schema: public; Owner: monitoring_user
--

CREATE VIEW public.pending_knob_applications AS
 SELECT kar.idempotency_key,
    kar.trace_id,
    kar.station_key,
    kar.apply_at_bucket_ts,
    kar.knobs,
    kar.created_at,
    kar.applied_at,
    kar.config_version,
    ...
    now() AS "current_time",
    ((kar.apply_at_bucket_ts)::timestamp with time zone - now()) AS time_until_apply
   FROM (public.knob_apply_requests kar
     LEFT JOIN public.traces t ON ((t.trace_id = (kar.trace_id)::text)))
  WHERE (((kar.status)::text = 'scheduled'::text) AND (kar.apply_at_bucket_ts > now()))
  ORDER BY kar.apply_at_bucket_ts;


ALTER TABLE public.pending_knob_applications OWNER TO monitoring_user;

--
-- Name: scheduled_knob_updates; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.scheduled_knob_updates (
    id integer NOT NULL,
    idempotency_key uuid NOT NULL,
    trace_id character varying(255),
    station_key character varying(50),
    apply_at_bucket_ts timestamp with time zone,
    knobs jsonb,
...
ALTER TABLE public.scheduled_knob_updates OWNER TO postgres;

--
-- Name: scheduled_knob_updates_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.scheduled_knob_updates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.scheduled_knob_updates_id_seq OWNER TO postgres;

--
-- Name: scheduled_knob_updates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.scheduled_knob_updates_id_seq OWNED BY public.scheduled_knob_updates.id;
...
--
-- Name: knob_apply_verification id; Type: DEFAULT; Schema: public; Owner: monitoring_user
--

ALTER TABLE ONLY public.knob_apply_verification ALTER COLUMN id SET DEFAULT nextval('public.knob_apply_verification_id_seq'::regclass);
...
--
-- Name: knob_verifications id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.knob_verifications ALTER COLUMN id SET DEFAULT nextval('public.knob_verifications_id_seq'::regclass);
...
--
-- Name: scheduled_knob_updates id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scheduled_knob_updates ALTER COLUMN id SET DEFAULT nextval('public.scheduled_knob_updates_id_seq'::regclass);
...
--
-- Name: knob_apply_requests knob_apply_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: monitoring_user
--

ALTER TABLE ONLY public.knob_apply_requests
    ADD CONSTRAINT knob_apply_requests_pkey PRIMARY KEY (idempotency_key);


--
-- Name: knob_apply_verification knob_apply_verification_pkey; Type: CONSTRAINT; Schema: public; Owner: monitoring_user
--

ALTER TABLE ONLY public.knob_apply_verification
    ADD CONSTRAINT knob_apply_verification_pkey PRIMARY KEY (id);
...
--
-- Name: knob_verifications knob_verifications_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.knob_verifications
    ADD CONSTRAINT knob_verifications_pkey PRIMARY KEY (id);
...
--
-- Name: scheduled_knob_updates scheduled_knob_updates_idempotency_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scheduled_knob_updates
    ADD CONSTRAINT scheduled_knob_updates_idempotency_key_key UNIQUE (idempotency_key);


--
-- Name: scheduled_knob_updates scheduled_knob_updates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scheduled_knob_updates
    ADD CONSTRAINT scheduled_knob_updates_pkey PRIMARY KEY (id);
...
--
-- Name: idx_knob_apply_bucket; Type: INDEX; Schema: public; Owner: monitoring_user
--

CREATE INDEX idx_knob_apply_bucket ON public.knob_apply_requests USING btree (apply_at_bucket_ts) WHERE ((status)::text = 'scheduled'::text);


--
-- Name: idx_knob_apply_trace_station; Type: INDEX; Schema: public; Owner: monitoring_user
--

CREATE INDEX idx_knob_apply_trace_station ON public.knob_apply_requests USING btree (trace_id, station_key);


--
-- Name: idx_knob_verifications_trace; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_knob_verifications_trace ON public.knob_verifications USING btree (trace_id, bucket_ts);


--
-- Name: idx_scheduled_updates_pending; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_scheduled_updates_pending ON public.scheduled_knob_updates USING btree (apply_at_bucket_ts, status) WHERE ((status)::text = 'pending'::text);


--
-- Name: idx_verification_status; Type: INDEX; Schema: public; Owner: monitoring_user
--

CREATE INDEX idx_verification_status ON public.knob_apply_verification USING btree (verification_status);


--
-- Name: idx_verification_trace_station; Type: INDEX; Schema: public; Owner: monitoring_user
--

CREATE INDEX idx_verification_trace_station ON public.knob_apply_verification USING btree (trace_id, station_key);
...
--
-- Name: knob_apply_verification fk_idempotency; Type: FK CONSTRAINT; Schema: public; Owner: monitoring_user
--

ALTER TABLE ONLY public.knob_apply_verification
    ADD CONSTRAINT fk_idempotency FOREIGN KEY (idempotency_key) REFERENCES public.scheduled_knob_updates(idempotency_key) ON DELETE CASCADE;
...
--
-- Name: knob_verifications knob_verifications_trace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.knob_verifications
    ADD CONSTRAINT knob_verifications_trace_id_fkey FOREIGN KEY (trace_id) REFERENCES public.traces(trace_id);
...
--
-- Name: scheduled_knob_updates scheduled_knob_updates_trace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scheduled_knob_updates
    ADD CONSTRAINT scheduled_knob_updates_trace_id_fkey FOREIGN KEY (trace_id) REFERENCES public.traces(trace_id);
...
--
-- Name: TABLE scheduled_knob_updates; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.scheduled_knob_updates TO monitoring_user;


--
-- Name: SEQUENCE scheduled_knob_updates_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE public.scheduled_knob_updates_id_seq TO monitoring_user;
...
\unrestrict pCofjGd4hfzcL0wTvYCSGcqkhibTneCpmWPeMWTROFCuDGhcbxpgALBnBkpJHlF

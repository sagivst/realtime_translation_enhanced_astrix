...
socket5000.on('message', (msg, rinfo) => {
  ...
  if (endpoint9008) {
    ...
    // DISABLED TO PREVENT RTP LOOPBACK:     socket5001.send(scaledMsg, endpoint9008.port, endpoint9008.address);
  }
});
...
socket5001.on('message', (msg, rinfo) => {
  ...
  if (endpoint9007) {
    ...
    // DISABLED TO PREVENT RTP LOOPBACK:     socket5000.send(scaledMsg, endpoint9007.port, endpoint9007.address);
  }
});

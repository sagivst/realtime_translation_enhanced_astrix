#!/usr/bin/env node
/**
 * Gateway for Extension 5555 - BUFFERED VERSION
...
const CONFIG = {
  extensionId: '5555',
  fromAsteriskPort: 4010,
  toAsteriskPort: 4011,
  toConfServerPort: 6110,
  fromConfServerPort: 6111,
  confServerHost: '127.0.0.1',
  sampleRate: 16000,
  frameSizeMs: 20,
  samplesPerFrame: 320,
  maxBufferedPackets: 1000,  // Buffer up to 20 seconds (1000 * 20ms)
  logFile: '/tmp/gateway-5555-buffered.log'
};
...
function init() {
  log('='.repeat(80));
  log('Gateway-5555 - BUFFERED VERSION (Prevents Packet Loss)');
  log('='.repeat(80));

 ...
 *
 * Architecture:
 *   Asterisk ExternalMedia (9007/9008)
...
// Statistics
const stats = {
  '9007': { packetsReceived: 0, bytesReceived: 0 },
  '9008': { packetsReceived: 0, bytesReceived: 0 }
};
...
async function main() {
  ...
  console.log('  Asterisk ExternalMedia (9007/9008)');
  console.log('    ↓ UDP RTP');

...
// Configuration for 4444
const config = {
    asteriskRtpPort: 4022,     // From Asterisk (via ARI)
    asteriskHost: '127.0.0.1',
    udpOutPort: 6122,          // To STTTTSserver
    udpInPort: 6123,           // From STTTTSserver
...
console.log(`Gateway 4444 starting...`);
...
console.log('Gateway 4444 ready');
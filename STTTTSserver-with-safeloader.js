...
// ========================================================================
// STATION KNOB SAFE LOADER - Captures system defaults for missing knobs
// ========================================================================
...
function getCurrentSystemKnobs() {
  // These should return the ACTUAL values currently in use by the system
  return {
    // AGC knobs
    'agc.enabled': true,
    'agc.targetLevel': -18,
...
// Export for use elsewhere in STTTTSserver
global.loadStationConfiguration = loadStationConfiguration;
global.getCurrentSystemKnobs = getCurrentSystemKnobs;

...
| STATION_3 | STTTTSserver → Deepgram | Voice (PCM) prep for STT | 3333, 4444 | 3333:  (Caller)<br>4444:  (Callee) |
| STATION_4 | Deepgram Response | STT processing results | 3333, 4444 | 3333:  STT<br>4444: STT |
...
| STATION_7 | Audio Enhancement | TTS (PCM) Post-processing | 3333, 4444 | Placeholder |
| STATION_8 | Recording/Archive | Call recording | 3333, 4444 | Not implemented |
| STATION_9 | STTTTSserver → Gateway | TTS (PCM) to Gateway output | 3333, 4444 | - |
| STATION_10 | Gateway → Asterisk | (RTP) Final audio delivery | 3333, 4444 | - |
| STATION_11 | STTTTSserver → Hume | (PCM) Emotional AI branch | 3333, 4444 | - |
| STATION_12 | Hume Response | Emotional AI response | 3333, 4444 | Planned |

### 3.3 Metric Definitions00
